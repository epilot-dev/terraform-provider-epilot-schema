...
page_title: "terraform_schema Data Source - terraform-provider-epilot-schema"
subcategory: ""
description: |-
  Schema DataSource
---

# terraform_schema (Data Source)
...
```terraform
data "terraform_schema" "my_schema" {
  id   = "f1583f0d-8744-453a-a4df-3f2b38fdc9e0"
  slug = "contact"
}
```
...
- `currency_1` (Attributes) A currency configuration (see [below for nested schema](#nestedatt--attributes--currency_attribute--currency--currency_1))

<a id="nestedatt--attributes--currency_attribute--currency--currency_1"></a>
### Nested Schema for `attributes.currency_attribute.currency.currency_1`
...
- `options_2` (Attributes) (see [below for nested schema](#nestedatt--attributes--status_attribute--options--options_2))
- `str` (String)

<a id="nestedatt--attributes--status_attribute--options--options_2"></a>
...
- `currency_1` (Attributes) A currency configuration (see [below for nested schema](#nestedatt--capabilities--attributes--currency_attribute--value_formatter--currency_1))

<a id="nestedatt--capabilities--attributes--currency_attribute--value_formatter--currency_1"></a>
### Nested Schema for `capabilities.attributes.currency_attribute.value_formatter.currency_1`
...
- `options_2` (Attributes) (see [below for nested schema](#nestedatt--capabilities--attributes--status_attribute--value_formatter--options_2))
- `str` (String)

<a id="nestedatt--capabilities--attributes--status_attribute--value_formatter--options_2"></a>
### Nested Schema for `capabilities.attributes.status_attribute.value_formatter.options_2`
...
- `entity_action` (Attributes) An entity action configured from the entity schema (see [below for nested schema](#nestedatt--ui_config--table_view--entity_default_table--view_type--entity_action))
- `str` (String)
