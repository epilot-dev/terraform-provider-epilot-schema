...
- `id` (String) ID for the entity attribute. Requires replacement if changed. ; Not Null
...
- `id` (String) ID for the entity capability. Requires replacement if changed. ; Not Null
