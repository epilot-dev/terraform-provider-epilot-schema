...
page_title: "terraform_schema Resource - terraform-provider-epilot-schema"
subcategory: ""
description: |-
  Schema Resource
---

# terraform_schema (Resource)
...
- `currency_1` (Attributes) A currency configuration. Requires replacement if changed. (see [below for nested schema](#nestedatt--attributes--currency_attribute--currency--currency_1))
...
- `options_2` (Attributes) Requires replacement if changed. (see [below for nested schema](#nestedatt--attributes--status_attribute--options--options_2))
- `str` (String) Requires replacement if changed.
...
- `currency_1` (Attributes) A currency configuration. Requires replacement if changed. (see [below for nested schema](#nestedatt--capabilities--attributes--currency_attribute--value_formatter--currency_1))
...
- `options_2` (Attributes) Requires replacement if changed. (see [below for nested schema](#nestedatt--capabilities--attributes--status_attribute--value_formatter--options_2))
- `str` (String) Requires replacement if changed.
