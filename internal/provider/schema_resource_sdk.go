...
func (r *SchemaResourceModel) ToSharedEntitySchema() *shared.EntitySchema {
	...
	if r.UIConfig != nil {
		...
		if r.UIConfig.TableView != nil {
			...
			if r.UIConfig.TableView.EntityDefaultTable != nil {
				...
				var rowActions []shared.RowActions = nil
				...
				var bulkActions []shared.BulkActions = nil
				...
				for _, navbarActionsItem := range r.UIConfig.TableView.EntityDefaultTable.NavbarActions {
					...
					var options []shared.EntityDefaultTableOptions = nil
		...
		if r.UIConfig.EditView != nil {
			...
			if r.UIConfig.EditView.EntityDefaultEdit != nil {
				...
				var summaryAttributes []string = nil
		...
		if r.UIConfig.SingleView != nil {
			...
			if r.UIConfig.SingleView.EntityDefaultEdit != nil {
				...
				var summaryAttributes1 []string = nil
		...
		if r.UIConfig.ListItem != nil {
			var summaryAttributes2 []shared.SummaryAttributes = nil
			for _, summaryAttributesItem2 := range r.UIConfig.ListItem.SummaryAttributes {
				if summaryAttributesItem2.SummaryAttribute != nil {
					...
					var settingsFlag []shared.SettingFlag = nil
			...
			var quickActions []shared.EntityAction = nil
	...
	for _, capabilitiesItem := range r.Capabilities {
		...
		for _, attributesItem := range capabilitiesItem.Attributes {
			if attributesItem.TextAttribute != nil {
				...
				var settingsFlag1 []shared.SettingFlag = nil
			...
			if attributesItem.LinkAttribute != nil {
				...
				var settingsFlag2 []shared.SettingFlag = nil
			...
			if attributesItem.DateAttribute != nil {
				...
				var settingsFlag3 []shared.SettingFlag = nil
			...
			if attributesItem.CountryAttribute != nil {
				...
				var settingsFlag4 []shared.SettingFlag = nil
			...
			if attributesItem.BooleanAttribute != nil {
				...
				var settingsFlag5 []shared.SettingFlag = nil
			...
			if attributesItem.SelectAttribute != nil {
				...
				var settingsFlag6 []shared.SettingFlag = nil
			...
			if attributesItem.MultiSelectAttribute != nil {
				...
				var settingsFlag7 []shared.SettingFlag = nil
				...
				var options2 []shared.MultiSelectAttributeOptions = nil
				for _, optionsItem2 := range attributesItem.MultiSelectAttribute.Options {
					if !optionsItem2.Str.IsUnknown() && !optionsItem2.Str.IsNull() {
						str4 := optionsItem2.Str.ValueString()
						options2 = append(options2, shared.MultiSelectAttributeOptions{
							Str: &str4,
						})
					}
			...
			if attributesItem.StatusAttribute != nil {
				...
				var settingsFlag8 []shared.SettingFlag = nil
				...
				var options3 []shared.StatusAttributeOptions = nil
				for _, optionsItem3 := range attributesItem.StatusAttribute.Options {
					if !optionsItem3.Str.IsUnknown() && !optionsItem3.Str.IsNull() {
						str5 := optionsItem3.Str.ValueString()
						options3 = append(options3, shared.StatusAttributeOptions{
							Str: &str5,
						})
					}
					if optionsItem3.Two != nil {
						value3 := optionsItem3.Two.Value.ValueString()
						title3 := new(string)
						if !optionsItem3.Two.Title.IsUnknown() && !optionsItem3.Two.Title.IsNull() {
							*title3 = optionsItem3.Two.Title.ValueString()
						} else {
							title3 = nil
						}
			...
			if attributesItem.SequenceAttribute != nil {
				...
				var settingsFlag9 []shared.SettingFlag = nil
			...
			if attributesItem.RelationAttribute != nil {
				...
				var settingsFlag10 []shared.SettingFlag = nil
				...
				for _, actionsItem := range attributesItem.RelationAttribute.Actions {
					...
					var settingsFlag11 []shared.SettingFlag = nil
					...
					if actionsItem.NewEntityItem != nil {
						...
						var owners []shared.EntityOwner = nil
				...
				for _, summaryFieldsItem := range attributesItem.RelationAttribute.SummaryFields {
					if !summaryFieldsItem.Str.IsUnknown() && !summaryFieldsItem.Str.IsNull() {
						str6 := summaryFieldsItem.Str.ValueString()
			...
			if attributesItem.UserRelationAttribute != nil {
				...
				var settingsFlag12 []shared.SettingFlag = nil
			...
			if attributesItem.AddressRelationAttribute != nil {
				...
				var settingsFlag13 []shared.SettingFlag = nil
			...
			if attributesItem.PaymentMethodRelationAttribute != nil {
				...
				var settingsFlag14 []shared.SettingFlag = nil
			...
			if attributesItem.CurrencyAttribute != nil {
				...
				var settingsFlag15 []shared.SettingFlag = nil
			...
			if attributesItem.RepeatableAttribute != nil {
				...
				var settingsFlag16 []shared.SettingFlag = nil
			...
			if attributesItem.TagsAttribute != nil {
				...
				var settingsFlag17 []shared.SettingFlag = nil
				...
				var options4 []string = nil
				for _, optionsItem4 := range attributesItem.TagsAttribute.Options {
					options4 = append(options4, optionsItem4.ValueString())
				}
			...
			if attributesItem.NumberAttribute != nil {
				...
				var settingsFlag18 []shared.SettingFlag = nil
			...
			if attributesItem.ConsentAttribute != nil {
				...
				var settingsFlag19 []shared.SettingFlag = nil
			...
			if attributesItem.InternalAttribute != nil {
				...
				var settingsFlag20 []shared.SettingFlag = nil
			...
			if attributesItem.OrderedListAttribute != nil {
				...
				var settingsFlag21 []shared.SettingFlag = nil
			...
			if attributesItem.FileAttribute != nil {
				...
				var settingsFlag22 []shared.SettingFlag = nil
			...
			if attributesItem.ComputedAttribute != nil {
				...
				var settingsFlag23 []shared.SettingFlag = nil
			...
			if attributesItem.PartnerStatusAttribute != nil {
				...
				var settingsFlag24 []shared.SettingFlag = nil
			...
			if attributesItem.InvitationEmailAttribute != nil {
				...
				var settingsFlag25 []shared.SettingFlag = nil
			...
			if attributesItem.AutomationAttribute != nil {
				...
				var settingsFlag26 []shared.SettingFlag = nil
			...
			if attributesItem.InternalUserAttribute != nil {
				...
				var settingsFlag27 []shared.SettingFlag = nil
			...
			if attributesItem.PurposeAttribute != nil {
				...
				var settingsFlag28 []shared.SettingFlag = nil
			...
			if attributesItem.PartnerOrganisationAttribute != nil {
				...
				var settingsFlag29 []shared.SettingFlag = nil
		...
		var settingsFlag30 []shared.SettingFlag = nil
	...
	for _, groupSettingsItem := range r.GroupSettings {
		...
		var settingsFlag31 []shared.SettingFlag = nil
	...
	for _, attributesItem1 := range r.Attributes {
		if attributesItem1.TextAttribute != nil {
			...
			var settingsFlag32 []shared.SettingFlag = nil
		...
		if attributesItem1.LinkAttribute != nil {
			...
			var settingsFlag33 []shared.SettingFlag = nil
		...
		if attributesItem1.DateAttribute != nil {
			...
			var settingsFlag34 []shared.SettingFlag = nil
		...
		if attributesItem1.CountryAttribute != nil {
			...
			var settingsFlag35 []shared.SettingFlag = nil
		...
		if attributesItem1.BooleanAttribute != nil {
			...
			var settingsFlag36 []shared.SettingFlag = nil
		...
		if attributesItem1.SelectAttribute != nil {
			...
			var settingsFlag37 []shared.SettingFlag = nil
		...
		if attributesItem1.MultiSelectAttribute != nil {
			...
			var settingsFlag38 []shared.SettingFlag = nil
			...
			var options6 []shared.MultiSelectAttributeOptions = nil
			for _, optionsItem6 := range attributesItem1.MultiSelectAttribute.Options {
				if !optionsItem6.Str.IsUnknown() && !optionsItem6.Str.IsNull() {
					str8 := optionsItem6.Str.ValueString()
					options6 = append(options6, shared.MultiSelectAttributeOptions{
						Str: &str8,
					})
				}
				if optionsItem6.Two != nil {
					...
					if !optionsItem6.Two.Title.IsUnknown() && !optionsItem6.Two.Title.IsNull() {
						*title7 = optionsItem6.Two.Title.ValueString()
					} else {
						title7 = nil
					}
		...
		if attributesItem1.StatusAttribute != nil {
			...
			var settingsFlag39 []shared.SettingFlag = nil
			...
			var options7 []shared.StatusAttributeOptions = nil
			for _, optionsItem7 := range attributesItem1.StatusAttribute.Options {
				if !optionsItem7.Str.IsUnknown() && !optionsItem7.Str.IsNull() {
					str9 := optionsItem7.Str.ValueString()
					options7 = append(options7, shared.StatusAttributeOptions{
						Str: &str9,
					})
				}
				if optionsItem7.Two != nil {
					value6 := optionsItem7.Two.Value.ValueString()
					title8 := new(string)
					if !optionsItem7.Two.Title.IsUnknown() && !optionsItem7.Two.Title.IsNull() {
						*title8 = optionsItem7.Two.Title.ValueString()
					} else {
						title8 = nil
					}
					options22 := shared.Options2{
						Value: value6,
						Title: title8,
					}
					options7 = append(options7, shared.StatusAttributeOptions{
		...
		if attributesItem1.SequenceAttribute != nil {
			...
			var settingsFlag40 []shared.SettingFlag = nil
		...
		if attributesItem1.RelationAttribute != nil {
			...
			var settingsFlag41 []shared.SettingFlag = nil
			...
			for _, actionsItem1 := range attributesItem1.RelationAttribute.Actions {
				...
				var settingsFlag42 []shared.SettingFlag = nil
				...
				if actionsItem1.NewEntityItem != nil {
					id3 := actionsItem1.NewEntityItem.ID.ValueString()
					org1 := actionsItem1.NewEntityItem.Org.ValueString()
					var owners1 []shared.EntityOwner = nil
					...
					if !actionsItem1.NewEntityItem.Title.IsUnknown() && !actionsItem1.NewEntityItem.Title.IsNull() {
						*title9 = actionsItem1.NewEntityItem.Title.ValueString()
					} else {
						title9 = nil
					}
			...
			for _, summaryFieldsItem1 := range attributesItem1.RelationAttribute.SummaryFields {
				if !summaryFieldsItem1.Str.IsUnknown() && !summaryFieldsItem1.Str.IsNull() {
					str10 := summaryFieldsItem1.Str.ValueString()
		...
		if attributesItem1.UserRelationAttribute != nil {
			...
			var settingsFlag43 []shared.SettingFlag = nil
		...
		if attributesItem1.AddressRelationAttribute != nil {
			...
			var settingsFlag44 []shared.SettingFlag = nil
		...
		if attributesItem1.PaymentMethodRelationAttribute != nil {
			...
			var settingsFlag45 []shared.SettingFlag = nil
		...
		if attributesItem1.CurrencyAttribute != nil {
			...
			var settingsFlag46 []shared.SettingFlag = nil
			...
			var currency2 []shared.Currency = nil
			for _, currencyItem1 := range attributesItem1.CurrencyAttribute.Currency {
				if currencyItem1.One != nil {
					...
					currency11 := shared.Currency1{
						Code:        code1,
						Description: description1,
						Symbol:      symbol1,
						Flag:        flag1,
					}
					currency2 = append(currency2, shared.Currency{
						Currency1: &currency11,
					})
				}
			}
		...
		if attributesItem1.RepeatableAttribute != nil {
			...
			var settingsFlag47 []shared.SettingFlag = nil
		...
		if attributesItem1.TagsAttribute != nil {
			...
			var settingsFlag48 []shared.SettingFlag = nil
			...
			var options8 []string = nil
			for _, optionsItem8 := range attributesItem1.TagsAttribute.Options {
				options8 = append(options8, optionsItem8.ValueString())
			}
		...
		if attributesItem1.NumberAttribute != nil {
			...
			var settingsFlag49 []shared.SettingFlag = nil
		...
		if attributesItem1.ConsentAttribute != nil {
			...
			var settingsFlag50 []shared.SettingFlag = nil
		...
		if attributesItem1.InternalAttribute != nil {
			...
			var settingsFlag51 []shared.SettingFlag = nil
		...
		if attributesItem1.OrderedListAttribute != nil {
			...
			var settingsFlag52 []shared.SettingFlag = nil
		...
		if attributesItem1.FileAttribute != nil {
			...
			var settingsFlag53 []shared.SettingFlag = nil
		...
		if attributesItem1.ComputedAttribute != nil {
			...
			var settingsFlag54 []shared.SettingFlag = nil
		...
		if attributesItem1.PartnerStatusAttribute != nil {
			...
			var settingsFlag55 []shared.SettingFlag = nil
		...
		if attributesItem1.InvitationEmailAttribute != nil {
			...
			var settingsFlag56 []shared.SettingFlag = nil
		...
		if attributesItem1.AutomationAttribute != nil {
			...
			var settingsFlag57 []shared.SettingFlag = nil
		...
		if attributesItem1.InternalUserAttribute != nil {
			...
			var settingsFlag58 []shared.SettingFlag = nil
		...
		if attributesItem1.PurposeAttribute != nil {
			...
			var settingsFlag59 []shared.SettingFlag = nil
			...
			if !attributesItem1.PurposeAttribute.ID.IsUnknown() && !attributesItem1.PurposeAttribute.ID.IsNull() {
				*id4 = attributesItem1.PurposeAttribute.ID.ValueString()
			} else {
				id4 = nil
			}
			slug2 := new(string)
		...
		if attributesItem1.PartnerOrganisationAttribute != nil {
			...
			var settingsFlag60 []shared.SettingFlag = nil
...
func (r *SchemaResourceModel) RefreshFromSharedEntitySchema(resp *shared.EntitySchema) {
