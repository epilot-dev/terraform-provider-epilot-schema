...
func (r *SchemaAttributeResourceModel) ToSharedAttribute() *shared.Attribute {
	...
	if r.TextAttribute != nil {
		...
		if !r.TextAttribute.Type.IsUnknown() && !r.TextAttribute.Type.IsNull() {
			*typeVar = shared.Type(r.TextAttribute.Type.ValueString())
		} else {
			typeVar = nil
		}
		multiline := new(bool)
	...
	if r.LinkAttribute != nil {
		...
		if !r.LinkAttribute.Type.IsUnknown() && !r.LinkAttribute.Type.IsNull() {
			*typeVar1 = shared.LinkAttributeType(r.LinkAttribute.Type.ValueString())
		} else {
			typeVar1 = nil
		}
	...
	if r.DateAttribute != nil {
		...
		if !r.DateAttribute.Type.IsUnknown() && !r.DateAttribute.Type.IsNull() {
			*typeVar2 = shared.DateAttributeType(r.DateAttribute.Type.ValueString())
		} else {
			typeVar2 = nil
		}
	...
	if r.CountryAttribute != nil {
		...
		if !r.CountryAttribute.Type.IsUnknown() && !r.CountryAttribute.Type.IsNull() {
			*typeVar3 = shared.CountryAttributeType(r.CountryAttribute.Type.ValueString())
		} else {
			typeVar3 = nil
		}
	...
	if r.BooleanAttribute != nil {
		...
		if !r.BooleanAttribute.Type.IsUnknown() && !r.BooleanAttribute.Type.IsNull() {
			*typeVar4 = shared.BooleanAttributeType(r.BooleanAttribute.Type.ValueString())
		} else {
			typeVar4 = nil
		}
	...
	if r.SelectAttribute != nil {
		...
		if !r.SelectAttribute.Type.IsUnknown() && !r.SelectAttribute.Type.IsNull() {
			*typeVar5 = shared.SelectAttributeType(r.SelectAttribute.Type.ValueString())
		} else {
			typeVar5 = nil
		}
	...
	if r.MultiSelectAttribute != nil {
		...
		if !r.MultiSelectAttribute.Type.IsUnknown() && !r.MultiSelectAttribute.Type.IsNull() {
			*typeVar6 = shared.MultiSelectAttributeType(r.MultiSelectAttribute.Type.ValueString())
		} else {
			typeVar6 = nil
		}
	...
	if r.StatusAttribute != nil {
		...
		if !r.StatusAttribute.Type.IsUnknown() && !r.StatusAttribute.Type.IsNull() {
			*typeVar7 = shared.StatusAttributeType(r.StatusAttribute.Type.ValueString())
		} else {
			typeVar7 = nil
		}
	...
	if r.SequenceAttribute != nil {
		...
		if !r.SequenceAttribute.Type.IsUnknown() && !r.SequenceAttribute.Type.IsNull() {
			*typeVar8 = shared.SequenceAttributeType(r.SequenceAttribute.Type.ValueString())
		} else {
			typeVar8 = nil
		}
		prefix := new(string)
	...
	if r.RelationAttribute != nil {
		...
		if !r.RelationAttribute.Type.IsUnknown() && !r.RelationAttribute.Type.IsNull() {
			*typeVar9 = shared.RelationAttributeType(r.RelationAttribute.Type.ValueString())
		} else {
			typeVar9 = nil
		}
		...
		if !r.RelationAttribute.RelationType.IsUnknown() && !r.RelationAttribute.RelationType.IsNull() {
			*relationType = shared.RelationType(r.RelationAttribute.RelationType.ValueString())
		} else {
			relationType = nil
		}
		...
		if !r.RelationAttribute.RelationAffinityMode.IsUnknown() && !r.RelationAttribute.RelationAffinityMode.IsNull() {
			*relationAffinityMode = shared.RelationAffinityMode(r.RelationAttribute.RelationAffinityMode.ValueString())
		} else {
		...
		if !r.RelationAttribute.EditMode.IsUnknown() && !r.RelationAttribute.EditMode.IsNull() {
			*editMode = shared.EditMode(r.RelationAttribute.EditMode.ValueString())
		} else {
			editMode = nil
		}
		...
		if !r.RelationAttribute.DrawerSize.IsUnknown() && !r.RelationAttribute.DrawerSize.IsNull() {
			*drawerSize = shared.DrawerSize(r.RelationAttribute.DrawerSize.ValueString())
		} else {
			drawerSize = nil
		}
	...
	if r.UserRelationAttribute != nil {
		...
		if !r.UserRelationAttribute.Type.IsUnknown() && !r.UserRelationAttribute.Type.IsNull() {
			*typeVar10 = shared.UserRelationAttributeType(r.UserRelationAttribute.Type.ValueString())
		} else {
			typeVar10 = nil
		}
		multiple := new(bool)
	...
	if r.AddressRelationAttribute != nil {
		...
		if !r.AddressRelationAttribute.Type.IsUnknown() && !r.AddressRelationAttribute.Type.IsNull() {
			*typeVar11 = shared.AddressRelationAttributeType(r.AddressRelationAttribute.Type.ValueString())
		} else {
			typeVar11 = nil
		}
	...
	if r.PaymentMethodRelationAttribute != nil {
		...
		if !r.PaymentMethodRelationAttribute.Type.IsUnknown() && !r.PaymentMethodRelationAttribute.Type.IsNull() {
			*typeVar12 = shared.PaymentMethodRelationAttributeType(r.PaymentMethodRelationAttribute.Type.ValueString())
		} else {
			typeVar12 = nil
		}
	...
	if r.CurrencyAttribute != nil {
		...
		typeVar13 := shared.CurrencyAttributeType(r.CurrencyAttribute.Type.ValueString())
	...
	if r.RepeatableAttribute != nil {
		...
		if !r.RepeatableAttribute.RelationAffinityMode.IsUnknown() && !r.RepeatableAttribute.RelationAffinityMode.IsNull() {
			*relationAffinityMode1 = shared.RepeatableAttributeRelationAffinityMode(r.RepeatableAttribute.RelationAffinityMode.ValueString())
		} else {
		...
		if !r.RepeatableAttribute.Type.IsUnknown() && !r.RepeatableAttribute.Type.IsNull() {
			*typeVar14 = shared.RepeatableAttributeType(r.RepeatableAttribute.Type.ValueString())
		} else {
			typeVar14 = nil
		}
	...
	if r.TagsAttribute != nil {
		...
		if !r.TagsAttribute.Type.IsUnknown() && !r.TagsAttribute.Type.IsNull() {
			*typeVar15 = shared.TagsAttributeType(r.TagsAttribute.Type.ValueString())
		} else {
			typeVar15 = nil
		}
	...
	if r.NumberAttribute != nil {
		...
		if !r.NumberAttribute.Type.IsUnknown() && !r.NumberAttribute.Type.IsNull() {
			*typeVar16 = shared.NumberAttributeType(r.NumberAttribute.Type.ValueString())
		} else {
			typeVar16 = nil
		}
		format := new(string)
	...
	if r.ConsentAttribute != nil {
		...
		typeVar17 := shared.ConsentAttributeType(r.ConsentAttribute.Type.ValueString())
	...
	if r.InternalAttribute != nil {
		...
		if !r.InternalAttribute.Type.IsUnknown() && !r.InternalAttribute.Type.IsNull() {
			*typeVar18 = shared.InternalAttributeType(r.InternalAttribute.Type.ValueString())
		} else {
			typeVar18 = nil
		}
	...
	if r.OrderedListAttribute != nil {
		...
		if !r.OrderedListAttribute.Type.IsUnknown() && !r.OrderedListAttribute.Type.IsNull() {
			*typeVar19 = shared.OrderedListAttributeType(r.OrderedListAttribute.Type.ValueString())
		} else {
			typeVar19 = nil
		}
	...
	if r.FileAttribute != nil {
		...
		typeVar20 := shared.FileAttributeType(r.FileAttribute.Type.ValueString())
		multiple1 := new(bool)
		...
		if !r.FileAttribute.DefaultAccessControl.IsUnknown() && !r.FileAttribute.DefaultAccessControl.IsNull() {
			*defaultAccessControl = shared.DefaultAccessControl(r.FileAttribute.DefaultAccessControl.ValueString())
		} else {
	...
	if r.ComputedAttribute != nil {
		...
		if !r.ComputedAttribute.Type.IsUnknown() && !r.ComputedAttribute.Type.IsNull() {
			*typeVar21 = shared.ComputedAttributeType(r.ComputedAttribute.Type.ValueString())
		} else {
			typeVar21 = nil
		}
	...
	if r.PartnerStatusAttribute != nil {
		...
		if !r.PartnerStatusAttribute.Type.IsUnknown() && !r.PartnerStatusAttribute.Type.IsNull() {
			*typeVar22 = shared.PartnerStatusAttributeType(r.PartnerStatusAttribute.Type.ValueString())
		} else {
			typeVar22 = nil
		}
	...
	if r.InvitationEmailAttribute != nil {
		...
		if !r.InvitationEmailAttribute.Type.IsUnknown() && !r.InvitationEmailAttribute.Type.IsNull() {
			*typeVar23 = shared.InvitationEmailAttributeType(r.InvitationEmailAttribute.Type.ValueString())
		} else {
			typeVar23 = nil
		}
	...
	if r.AutomationAttribute != nil {
		...
		if !r.AutomationAttribute.Type.IsUnknown() && !r.AutomationAttribute.Type.IsNull() {
			*typeVar24 = shared.AutomationAttributeType(r.AutomationAttribute.Type.ValueString())
		} else {
			typeVar24 = nil
		}
	...
	if r.InternalUserAttribute != nil {
		...
		if !r.InternalUserAttribute.Type.IsUnknown() && !r.InternalUserAttribute.Type.IsNull() {
			*typeVar25 = shared.InternalUserAttributeType(r.InternalUserAttribute.Type.ValueString())
		} else {
			typeVar25 = nil
		}
	...
	if r.PurposeAttribute != nil {
		...
		if !r.PurposeAttribute.Type.IsUnknown() && !r.PurposeAttribute.Type.IsNull() {
			*typeVar26 = shared.PurposeAttributeType(r.PurposeAttribute.Type.ValueString())
		} else {
			typeVar26 = nil
		}
	...
	if r.PartnerOrganisationAttribute != nil {
		...
		if !r.PartnerOrganisationAttribute.Type.IsUnknown() && !r.PartnerOrganisationAttribute.Type.IsNull() {
			*typeVar27 = shared.PartnerOrganisationAttributeType(r.PartnerOrganisationAttribute.Type.ValueString())
		} else {
			typeVar27 = nil
		}
...
func (r *SchemaAttributeResourceModel) RefreshFromSharedAttributeWithCompositeID(resp *shared.AttributeWithCompositeID) {
	if resp != nil {
		...
		if resp.AttributeWithCompositeID != nil {
