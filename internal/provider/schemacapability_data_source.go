...
var _ datasource.DataSource = &SchemaCapabilityDataSource{}
var _ datasource.DataSourceWithConfigure = &SchemaCapabilityDataSource{}

func NewSchemaCapabilityDataSource() datasource.DataSource {
	return &SchemaCapabilityDataSource{}
}
...
// SchemaCapabilityDataSourceModel describes the data model.
type SchemaCapabilityDataSourceModel struct {
...
func (r *SchemaCapabilityDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_schema_capability"
}

// Schema defines the schema for the data source.
func (r *SchemaCapabilityDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "SchemaCapability DataSource",
					...
					Attributes: map[string]schema.Attribute{
						...
						"boolean_attribute": schema.SingleNestedAttribute{
							...
							Attributes: map[string]schema.Attribute{
								...
								"display_type": schema.StringAttribute{
									Computed:    true,
									Description: `must be one of ["switch", "checkbox"]`,
								},
								"entity_builder_disable_edit": schema.BoolAttribute{
									Computed:    true,
									Description: `Setting to ` + "`" + `true` + "`" + ` disables editing the attribute on the entity builder UI`,
						...
						"payment_attribute": schema.SingleNestedAttribute{
							...
							Attributes: map[string]schema.Attribute{
								...
								"type": schema.StringAttribute{
									Computed:    true,
									Description: `must be one of ["payment"]`,
								},
								"value_formatter": schema.StringAttribute{
									Computed: true,
								},
						...
						"phone_attribute": schema.SingleNestedAttribute{
							...
							Attributes: map[string]schema.Attribute{
								...
								"type": schema.StringAttribute{
									Computed:    true,
									Description: `must be one of ["phone"]`,
								},
								"value_formatter": schema.StringAttribute{
									Computed: true,
								},
						...
						"price_component_attribute": schema.SingleNestedAttribute{
							...
							Attributes: map[string]schema.Attribute{
								...
								"type": schema.StringAttribute{
									Computed:    true,
									Description: `must be one of ["price_component"]`,
								},
								"value_formatter": schema.StringAttribute{
									Computed: true,
								},
						...
						"text_attribute": schema.SingleNestedAttribute{
							...
							Attributes: map[string]schema.Attribute{
								...
								"rows": schema.SingleNestedAttribute{
									Computed: true,
									Attributes: map[string]schema.Attribute{
...
func (r *SchemaCapabilityDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *SchemaCapabilityDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *SchemaCapabilityDataSourceModel
