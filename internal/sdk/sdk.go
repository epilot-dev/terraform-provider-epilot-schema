...
// Generated from OpenAPI doc version 2.8.0 and generator version 2.869.25
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.18.5",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.18.5 2.869.25 2.8.0 github.com/epilot/terraform-provider-epilot-schema/internal/sdk",
