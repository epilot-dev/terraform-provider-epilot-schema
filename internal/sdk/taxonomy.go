...
func (s *Taxonomy) CreateTaxonomy(ctx context.Context, request *operations.CreateTaxonomyRequestBody, opts ...operations.Option) (*operations.CreateTaxonomyResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Taxonomy) CreateTaxonomyClassification(ctx context.Context, request operations.CreateTaxonomyClassificationRequest, opts ...operations.Option) (*operations.CreateTaxonomyClassificationResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/entity/taxonomies/{taxonomySlug}/classifications", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Taxonomy) UpdateTaxonomyClassification(ctx context.Context, request operations.UpdateTaxonomyClassificationRequest, opts ...operations.Option) (*operations.UpdateTaxonomyClassificationResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/entity/taxonomies/{taxonomySlug}/classifications/{classificationSlug}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
